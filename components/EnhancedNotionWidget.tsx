    ...
    return (
      <div className="relative [&>*:first-child]:hidden [&>*:nth-child(2)]:hidden [&>*:nth-last-child(1)]:hidden [&>*:nth-last-child(2)]:hidden">
        <LiquidGlass
          ...
          mode="shader"
          padding="0px"
          className="!transform !translate-x-0 !translate-y-0 !scale-100 w-[350px] [&>*:nth-last-child(1)]:w-full [&>*:nth-last-child(1)>div]:w-full">
          <div className="rounded-2xl p-7 border border-white/5 transition-all duration-300 hover:border-white/10 h-[450px] w-full flex flex-col">
            <div className="flex flex-col h-full">
              <div className="flex justify-between items-center mb-6">
                <h3
                  className={`text-lg font-medium tracking-wide ${
                    isDark ? "text-text-primary" : "text-text-tertiary"
                  }`}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full p-3 text-sm transition-all duration-200 bg-transparent border rounded-lg bg-primary/30 text-text-primary placeholder-text-secondary/50 focus:border-accent-purple/50 focus:ring-2 focus:ring-accent-purple/20 focus:outline-none ${
                        isDark
  ...
  return (
    <div className="relative [&>*:first-child]:hidden [&>*:nth-child(2)]:hidden [&>*:nth-last-child(1)]:hidden [&>*:nth-last-child(2)]:hidden ">
      <LiquidGlass
        ...
        mode="shader"
        padding="0px"
        className="!transform !translate-x-0 !translate-y-0 !scale-100 w-[350px] [&>*:nth-last-child(1)]:w-full [&>div]:!overflow-visible [&>*:nth-last-child(1)>div]:w-full [&>*:nth-last-child(1)>svg]:overflow-hidden [&>div>span]:rounded-2xl [&>div>span]:overflow-clip">
        <div className="rounded-2xl p-7 border border-white/5 transition-all duration-300 hover:border-white/10 h-[450px] flex w-full flex-col">
          <div className="flex flex-col h-full">
            ...
            <div
              className={`flex-1 px-2 overflow-x-hidden overflow-y-auto [&::-webkit-scrollbar]:bg-transparent [&::-webkit-scrollbar-thumb]:w-1 [&::-webkit-scrollbar-thumb]:rounded-full rounded-lg bg-primary/20 ${
                isDark
              ...
              {blocks.length > 0 ? (
                ...
                <div className="flex flex-col gap-2 justify-center items-center w-full h-full">
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="none"
                    className={`size-5 flex justify-center items-center animate-spin ease-in-out ${
                      isDark
